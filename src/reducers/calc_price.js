const initialState = {
    ...
    calc_price_cargo_info_type: { key: 1, label: "Итоговые значения", value: "Итоговые значения" },
    CargoList: [{
        Weight: 0,
        L: 0,
        W: 0,
...
export default function dispatch(state = initialState, action) {
    switch (action.type) {
        case 'set_calc_price_cargo_info_type': return {
            ...state, calc_price_cargo_info_type: action.payload, CargoList: [{
                Weight: 0,
                L: 0,
                W: 0,
                H: 0,
                Q: 1,
            }], calc_price_weight: "", calc_price_h: "", calc_price_w: "", calc_price_l: "" }
        ...
        case 'set_calc_price_cargo_weight': return {
            ...state,
        ...
        case 'set_calc_price_cargoL': return {
            ...state,
            CargoList: state.CargoList.map((el, index) => {
                if (index == action.payload.index) {
        ...
        case 'set_calc_price_cargoH': return {
            ...state,
            CargoList: state.CargoList.map((el, index) => {
                if (index == action.payload.index) {
        ...
        case 'set_calc_price_cargoQ': return {
            ...state,
            CargoList: state.CargoList.map((el, index) => {
                if (index == action.payload.index) {
        ...
        case 'remove_calc_price_cargo': return {
            ...state,
