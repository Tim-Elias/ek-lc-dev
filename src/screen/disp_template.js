...
class Screen extends React.Component {
  ...
  save = () => {
    const data = {
      ...
      CurrentTerminal:
        this.props.store.templates.selected_disp_template.CurrentTerminal.label,
  ...
  render() {
    ...
    if (
      ...
      JSON.stringify(this.props.store.templates.original_data_disp_template)
    ) {
      changed = true;
    }
    return (
          ...
          <div>
            ...
            {this.props.store.templates.selected_disp_template.IsNew ? (
              ...
              <b className="page_header">
                (Код: {this.props.store.templates.selected_disp_template.Key})
              </b>
            )}
        ...
        <div className="templates_general_data">
          ...
          <div className="disp_data_el">
            <input
              ...
              onChange={(e) =>
                this.props.set_selected_disp_template_label(e.target.value)
              }
          ...
          <div className="disp_data_el">
            <Select
              ...
              styles={customStyles}
              onChange={(values) =>
                this.set_selected_disp_template_City(values)
              }
            />
          </div>

          {this.props.store.templates.disp_template_terminal_list.length ===
          0 ? null : (
            <div className="disp_data_label">Отправка/Выдача на складе</div>
          )}
          {this.props.store.templates.disp_template_terminal_list.length ===
          0 ? null : (
            <div>
          ...
          {this.props.store.templates.disp_template_terminal_list.length ===
          0 ? null : (
            <div className="disp_data_label">Забор/Доставка по адресу</div>
          )}
          {this.props.store.templates.disp_template_terminal_list.length ===
          0 ? null : (
            <div>
          ...
          {this.props.store.templates.selected_disp_template.Terminal ? (
            <div className="disp_data_el">
              <Select
                ...
                styles={customStyles}
                value={
                  this.props.store.templates.selected_disp_template
                    .CurrentTerminal
                }
                onChange={(values) =>
                  this.props.set_selected_disp_template_CurrentTerminal(values)
                }
              />
            </div>
          ) : (
            <div className="disp_data_el">
              <input
                ...
                className="create_disp_data_input"
                onChange={(e) =>
                  this.props.set_selected_disp_template_Adress(e.target.value)
                }
          ...
          <div className="disp_data_el">
            <input
              ...
              className="create_disp_data_input"
              onChange={(e) =>
                this.props.set_selected_disp_template_Phone(e.target.value)
              }
          ...
          <div className="disp_data_el">
            <input
              ...
              className="create_disp_data_input"
              onChange={(e) =>
                this.props.set_selected_disp_template_Person(e.target.value)
              }
          ...
          <div className="disp_data_el">
            <input
              ...
              className="create_disp_data_input"
              onChange={(e) =>
                this.props.set_selected_disp_template_Company(e.target.value)
              }
          ...
          <div className="disp_data_el">
            <input
              ...
              className="create_disp_data_input"
              onChange={(e) =>
                this.props.set_selected_disp_template_AddInfo(e.target.value)
              }
...
export default connect(
  ...
  (dispatch) => ({
    set_selected_disp_template_label: (param) => {
      dispatch({ type: "set_selected_disp_template_label", payload: param });
    },
    set_selected_disp_template_City: (param) => {
      dispatch({ type: "set_selected_disp_template_City", payload: param });
    },
    set_selected_disp_template_Adress: (param) => {
      dispatch({ type: "set_selected_disp_template_Adress", payload: param });
    },
    set_selected_disp_template_Phone: (param) => {
      dispatch({ type: "set_selected_disp_template_Phone", payload: param });
    },
    set_selected_disp_template_Person: (param) => {
      dispatch({ type: "set_selected_disp_template_Person", payload: param });
    },
    set_selected_disp_template_Company: (param) => {
      dispatch({ type: "set_selected_disp_template_Company", payload: param });
    },
    set_selected_disp_template_AddInfo: (param) => {
      dispatch({ type: "set_selected_disp_template_AddInfo", payload: param });
    },
