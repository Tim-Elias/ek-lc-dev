...
class StikerToPrint extends React.Component {
    ...
    create_table = () => {
        ...
        <div className='sticker_info'>{this.props.disp.data.RecAdress}</div> 
        <div className='sticker_info'>{this.props.disp.data.DelMethod}</div> 
        <div className='sticker_info'>{this.props.disp.data.Customer}</div> 
        <div className='sticker_cargo'>{i+1} из {this.props.disp.data.Total}</div> 
        <div className='sticker_barcode'><Barcode value={this.props.disp.data.Number} format='CODE39' width={1} height={30}/></div>
        <div className='sticker_site'> <p className='page_break'>www.express-kinetika.ru</p></div> 
        </div>
            )
        }
        return table
        ...
        {/* <div className='disp_print'> */}
          ...
          <div className="disp_print_address_data">
                  ...
                  <div className="disp_print_address_data_el">
                      ...
                      <div className="disp_print_data_el">{this.props.disp.data.SendCity}</div>
