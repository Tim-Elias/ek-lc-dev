    ...
    return (
      <div>
        ...
        <Segment className="home_segment" attached="bottom">
          ...
          {this.props.store.home.active_menu_item === "filial" ? (
            <Filial />
          ) : null}
          {this.props.store.home.active_menu_item === "contract" ? (
            <Contract />
          ) : null}
          {this.props.store.home.active_menu_item === "feedback" ? (
            <Feedback />
          ) : null}
        </Segment>
      </div>
...
export default connect(
  ...
  (dispatch) => ({
    set_active_menu_item: (param) => {
      dispatch({ type: "set_active_menu_item", payload: param });
    },
    SetCityList: (param) => {
