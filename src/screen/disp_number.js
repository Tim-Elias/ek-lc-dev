...
class Screen extends React.Component {
    ...
    get_my_disp_data = () => {
        ...
        get_data('mydisplist', data).then(
            ...
            (err) => {
                console.log(err) 
                this.props.set_erroe_mesage("Не удалось найти накладную")
            }
        );
        ...
        return (
            ...
            <div>
                ...
                <div onKeyDown={this.handleKeyDown.bind(this)} className="my_disp_control_panel my_disp_control_panel--s">
                    ...
                    <div>
                        <Button style={{ marginTop: '-5px' }} size='mini' onClick={this.get_my_disp_data.bind(this)}>Открыть накладную</Button>
                    </div>
                </div>
...
export default withCookies(connect(
    ...
    dispatch => ({
        ...
        set_erroe_mesage: (param) => { dispatch({ type: 'set_erroe_mesage', payload: param }) },
    })
)(Screen));