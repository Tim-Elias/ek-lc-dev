...
class Screen extends React.Component {
  ...
  render() {
    ...
    if (
      ...
      this.props.store.check.check_data.num ===
        this.props.store.movement.select_print_disp
    ) {
      print_button = false;
    } else {
      print_button = true;
          ...
          <div ref={(el) => (this.componentRef = el)}>
            <div className="check_print_qr">
              <div className="check_print_row check_print_row--center">
                {this.props.store.check.check_data.organization}
              </div>
              <div className="check_print_row check_print_row--center">
                Кассовый чек
              </div>
              ...
              <div className="check_print_row">
                Оплата по накладной {this.props.store.check.check_data.num}
              </div>
              <div className="check_print_row check_print_row--right">
                1.000 * {this.props.store.check.check_data.summ}&equiv;{" "}
              ...
              <div className="check_print_row">
                <div>
                  {this.props.store.check.check_data.type === 0
                    ? "Наличными"
                    : "Безналичными"}
                </div>
                <div>&equiv;{this.props.store.check.check_data.summ}</div>
