...
class Screen extends React.Component {
  ...
  componentDidMount() {
    ...
    if (
      this.props.store.check.check_data.num ===
  ...
  render() {
    ...
    return (
      <div>
        <div
          className={this.props.store.disp.popup ? "PopUp_container" : "none"}
        ...
        <div className={this.props.store.disp.popup ? "PopUp_window" : "none"}>
          ...
          <div className="PopUp_date">
            ...
            <div>
              Тип оплаты:{" "}
              {this.props.store.disp.type_cash ? "Безналичные" : "Наличные"}
            </div>
          ...
          <div className="PopUp_button_container">
            <button
              ...
              onClick={this.createcheck.bind(this)}
            >
              Да
            </button>
            <button className="PopUp_button" onClick={this.receipt.bind(this)}>
              Нет
            </button>
          </div>
        </div>
        ...
        {this.props.store.general.active_loader ? (
          ...
          <div>
            <div className="mobile_disp_button">
              <button
                className={
                  +this.props.store.disp.cash_accepted !==
                    +this.props.store.disp.data.COD &&
                  this.props.store.disp.data.ChangeSumm === false
                    ? "none"
                    : "mobile_disp_button_item"
                }
                onClick={this.sendpod.bind(this, false)}
              >
                Доставленно
              </button>
              <button
              ...
              <button
                className="mobile_disp_button_item--yellow mobile_disp_button_item"
                onClick={this.sendpod.bind(this, true)}
              >
                Частично доставленно
              </button>
            </div>
            ...
            <div className="mobile_disp_button">
              <button
                className={
                  ...
                  this.props.store.login.kkm &&
                  this.props.store.disp.data.CheckEnabled &&
                  this.props.store.disp.data.ChangeSumm === false
                    ? "mobile_disp_button_item mobile_disp_button_item--blue"
                    : "none"
                }
                onClick={this.receipt.bind(this)}
              >
            ...
            {this.props.store.login.original_data.print_ticket ? (
              <DispPrint />
            ) : null}
            ...
            <div className="mobile_container">
              ...
              <div className="mobile_del_row">
                ...
                <input
                  onChange={(e) => this.props.set_disp_date(e.target.value)}
                  value={this.props.store.disp.delivery_date}
              ...
              <div className="mobile_del_row">
                ...
                <input
                  onChange={(e) => this.props.set_disp_time(e.target.value)}
                  value={this.props.store.disp.delivery_time}
                  className="mobile_del_input"
                  type="time"
                ></input>
              </div>
              ...
              {this.props.store.disp.cash_accepted > 0 ? (
                <div className="mobile_del_row">
                  ...
                  <select
                    onChange={(e) => {
                      this.props.set_disp_type_cash(e.target.value);
                    }}
                  >
              ...
              <div className="mobile_del_row">
                ...
                <input
                  className="mobile_del_input"
                  value={this.props.store.disp.cash_accepted}
                  onChange={(e) => this.props.set_disp_cash(e.target.value)}
                  type="number"
                ></input>
                {this.props.store.disp.data.ChangeSumm ? (
                  <button onClick={() => this.props.set_disp_cash(0)}>X</button>
                ) : null}
              </div>
