...
class Screen extends React.Component {
  ...
  create_disp = () => {
    const create_disp_data = {
      ...
      SendTerminal: this.props.store.m_create_disp.SendTerminal,
      SendSelectTerminal:
        this.props.store.m_create_disp.SendSelectTerminal.value,
  ...
  render() {
    ...
    if (
      this.props.store.m_create_disp.SendCity.value === "" ||
      this.props.store.m_create_disp.RecCity.value === "" ||
      (this.props.store.m_create_disp.Total === "0" &&
        this.props.store.m_create_disp.CargoInfoType &&
        !this.props.store.login.original_data.nullablex) ||
      (this.props.store.m_create_disp.Weight === "0" &&
        this.props.store.m_create_disp.CargoInfoType &&
        !this.props.store.login.original_data.nullable) ||
      (total_weight === 0 &&
        !this.props.store.m_create_disp.CargoInfoType &&
        !this.props.store.login.original_data.nullable) ||
      ...
      <div>
        {this.props.store.general.active_loader ? (
          ...
          <div>
            <div
              className={
                this.props.store.m_create_disp.popup
                  ? "PopUp_container"
                  : "none"
              }
              onClick={this.receipt.bind(this)}
            ></div>
            <div
              className={
                this.props.store.m_create_disp.popup
            ...
            >
              {this.props.store.m_create_disp.popupType === "send" ? (
                <p>Заполнить отправителя из шаблона</p>
              ) : (
                <p>Заполнить получателя из шаблона</p>
              )}
              {this.props.store.upload_manifest.disp_template_list.map(
                (el, index) => (
                  <div key={index} className="PopUp_table">
                    <div className="PopUp_table_header">{el.label}</div>
                    ...
                    <button
                      ...
                      onClick={
                        this.props.store.m_create_disp.popupType === "send"
                          ? this.SelectSendTemplate.bind(this, el)
                          : this.SelectRecTemplate.bind(this, el)
                      }
                    >
                      Выбрать
                    </button>
            ...
            <div className="mobile_heading">Создать накладную</div>
            ...
            <div className="mobile_container">
              <div className="mobile_del_row">
                ...
                <input
                  ...
                  type="text"
                  value={this.props.store.m_create_disp.Number}
                  onChange={(e) => this.props.set_Number(e.target.value)}
                ></input>
              </div>

              <button
                style={{ margin: "0 0 10px 0" }}
                onClick={() => this.autoNumber()}
              >
                Автономер
              </button>
              ...
              <div className="mobile_del_row">
                ...
                {this.props.store.m_create_disp.Customer !== "" ? (
                  ...
                  <select
                    defaultValue=""
                    className="mobile_del_input"
                    onChange={(e) => this.props.set_Customer(e.target.value)}
                  >
              ...
              <div className="mobile_del_row">
                ...
                <input
                  className="mobile_del_input"
                  type="text"
                  value={this.props.store.m_create_disp.DelMethod}
                  readOnly
                ></input>
              </div>
              ...
              <div className="mobile_del_row">
                ...
                <select
                  defaultValue={this.props.store.m_create_disp.PayType}
                  className="mobile_del_input"
                  onChange={(e) => this.props.SetPayType(e.target.value)}
                >
                  <option value="БезналичнаяОплата">Безналичная оплата</option>
                  <option value="ОплатаНаличнымиПриОтправлении">
                    Оплата наличными при отправлении
                  </option>
                  <option value="ОплатаНаличнымиПриПолучении">
              ...
              <div className="mobile_table">
                <div className="mobile_table_header">
                  Данные отправителя
                  <button
                    className="mobile_table_header_button"
                    onClick={this.ShowPopUp.bind(this, "send")}
                  >
                    Из шаблона
                  </button>
                </div>
                ...
                {this.props.store.m_create_disp.SendTerminalList.length ===
                0 ? null : (
                  <div className="mobile_table_row">
                    <div className="mobile_table_label">Вид забора:</div>
                    <select
                      defaultValue={this.props.store.m_create_disp.SendTerminal}
                      className="mobile_table_el"
                      onChange={(e) => this.SendTerminal(e.target.value)}
                    >
                ...
                <div className="mobile_table_row">
                  {this.props.store.m_create_disp.SendTerminal ? (
                    <div className="mobile_table_label"> Терминал:</div>
                  ) : (
                    <div
                      className="mobile_table_label"
                      value={this.props.store.m_create_disp.SendAdress}
                ...
                <div className="mobile_table_row">
                  ...
                  <input
                    className="mobile_table_el"
                    value={this.props.store.m_create_disp.SendCompany}
                ...
                <div className="mobile_table_row">
                  ...
                  <input
                    className="mobile_table_el"
                    value={this.props.store.m_create_disp.SendPhone}
                ...
                <div className="mobile_table_row">
                  ...
                  <input
                    className="mobile_table_el"
                    value={this.props.store.m_create_disp.SendPerson}
                ...
                <div className="mobile_table_row">
                  ...
                  <input
                    className="mobile_table_el"
                    value={this.props.store.m_create_disp.SendAddInfo}
              ...
              <div className="mobile_table">
                <div className="mobile_table_header">
                  ...
                  <button
                    className="mobile_table_header_button"
                    onClick={this.ShowPopUp.bind(this, "Rec")}
                  >
                    Из шаблона
                  </button>
                </div>
                ...
                {this.props.store.m_create_disp.RecTerminalList.length ===
                0 ? null : (
                  <div className="mobile_table_row">
                    <div className="mobile_table_label">Вид доставки:</div>
                    <select
                      defaultValue={this.props.store.m_create_disp.RecTerminal}
                      className="mobile_table_el"
                      onChange={(e) => this.RecTerminal(e.target.value)}
                    >
                ...
                <div className="mobile_table_row">
                  {this.props.store.m_create_disp.RecTerminal ? (
                    ...
                    <div
                      className="mobile_table_label"
                      value={this.props.store.m_create_disp.RecAdress}
                      onChange={(e) => this.props.SetRecAdress(e.target.value)}
                    >
                      Адрес:
                    </div>
                  )}
                ...
                <div className="mobile_table_row">
                  ...
                  <input
                    className="mobile_table_el"
                    value={this.props.store.m_create_disp.RecCompany}
                    onChange={(e) => this.props.SetRecCompany(e.target.value)}
                  />
                </div>
                ...
                <div className="mobile_table_row">
                  ...
                  <input
                    className="mobile_table_el"
                    value={this.props.store.m_create_disp.RecPhone}
                    onChange={(e) => this.props.SetRecPhone(e.target.value)}
                  />
                </div>
                ...
                <div className="mobile_table_row">
                  ...
                  <input
                    className="mobile_table_el"
                    value={this.props.store.m_create_disp.RecPerson}
                    onChange={(e) => this.props.SetRecPerson(e.target.value)}
                  />
                </div>
                ...
                <div className="mobile_table_row">
                  ...
                  <input
                    className="mobile_table_el"
                    value={this.props.store.m_create_disp.RecAddInfo}
              ...
              <div className="mobile_del_row">
                <div className="mobile_del_data_label">
                  Метод внесения информации:
                </div>
                <select
                  defaultValue={this.props.store.m_create_disp.CargoInfoType}
                  className="mobile_del_input"
                  onChange={(e) => this.props.SetCargoInfoType(e.target.value)}
                >
                  <option value={false}>
                    Внести информацию о каждом грузе
                  </option>
              ...
              this.props.store.m_create_disp.Cargo_list.length > 0 ? (
                <div className="mobile_table">
                  <div className="mobile_table_header">Шаблоны грузов</div>

                  {this.props.store.m_create_disp.Cargo_list.map(
                    (item, index) => (
                      <div key={index} className="mobile_table_row">
                        <div className="mobile_table_label">{item.name}</div>
                        <button
                          className="mobile_table_cargo_button"
                          onClick={() => this.RemoveCargoTemplate(item)}
                        >
                          -
                        </button>
                        <input
                        ...
                        <button
                          className="mobile_table_cargo_button"
                          onClick={() => this.AddCargoTemplate(item)}
                        >
                          +
                        </button>
                      </div>
                    ...
                    <div className="mobile_table" key={index}>
                      <div className="mobile_table_row">
                        ...
                        <input
                          ...
                          value={item.Weight}
                          onChange={(e) =>
                            this.CargoWeight(e.target.value, index)
                          }
                          type="number"
                        />
                      </div>
                      ...
                      <div className="mobile_table_row">
                        ...
                        <input
                          className="mobile_table_el mobile_table_el--part"
                          value={item.L}
                          onChange={(e) => this.CargoL(e.target.value, index)}
                          type="number"
                          placeholder="Длина"
                        />
                        <input
                          className="mobile_table_el mobile_table_el--part"
                          value={item.W}
                          onChange={(e) => this.CargoW(e.target.value, index)}
                          type="number"
                          placeholder="Ширина"
                        />
                        <input
                          className="mobile_table_el mobile_table_el--part"
                          value={item.H}
                          onChange={(e) => this.CargoH(e.target.value, index)}
                          type="number"
                          placeholder="Высота"
                        />
                      </div>
                      ...
                      <div className="mobile_table_row">
                        ...
                        <div className="mobile_table_el">
                          {((item.L * item.W * item.H) / 5000).toFixed(3)}
                        </div>
                      </div>
                      ...
                      <div className="mobile_table_row">
                        ...
                        <select
                          ...
                          className="mobile_table_el"
                          onChange={(e) =>
                            this.CargoType(e.target.value, index)
                          }
                        >
                          <option value="" disabled>
                            Выберите тип груза
                      ...
                      <br />
                      <button
                        onClick={this.RemoveCargo.bind(this, index, item)}
                        className="mobile_disp_button_item mobile_disp_button_item--full mobile_disp_button_item--yellow"
                      >
                        Удалить место
                      </button>
                    </div>
              ...
              {this.props.store.m_create_disp.CargoInfoType === false ? (
                <div className="mobile_table">
                  ...
                  <div className="mobile_table_row">
                    <div className="mobile_table_label">
                  ...
                  <div className="mobile_table_row">
                    ...
                    <input
                      ...
                      type="number"
                      onChange={(e) =>
                        this.props.SetInsureValue(e.target.value)
                      }
                      value={this.props.store.m_create_disp.InsureValue}
                    />
                  </div>

                  <div className="mobile_table_row">
                    <div className="mobile_table_label">
                      Наложенный платеж (руб.):
                    </div>
                    <input
                      className="mobile_table_el"
                      type="number"
                      onChange={(e) => this.props.SetCOD(e.target.value)}
                      value={this.props.store.m_create_disp.COD}
                    />
                  </div>

                  <div className="mobile_table_row">
                    <div className="mobile_table_label">
                      Расчетная стоимость перевозки (руб.):
                    </div>
                    <input
                      className="mobile_table_el"
                      readOnly
                      value={this.props.store.m_create_disp.Price}
                      type="number"
                    />
                  </div>
                </div>
                ...
                <div className="mobile_table">
                  ...
                  <div className="mobile_table_row">
                    ...
                    <input
                      className="mobile_table_el"
                      type="number"
                      value={this.props.store.m_create_disp.Total}
                      onChange={(e) => this.props.SetTotal(e.target.value)}
                    />
                  </div>
                  ...
                  <div className="mobile_table_row">
                    ...
                    <input
                      className="mobile_table_el"
                      type="number"
                      value={this.props.store.m_create_disp.Weight}
                  ...
                  <div className="mobile_table_row">
                    ...
                    <input
                      className="mobile_table_el"
                      type="number"
                      value={this.props.store.m_create_disp.Volume}
              ...
              {disabled ? (
                <button
                  ...
                  className="mobile_disp_button_item--full mobile_disp_button_item--blue_nonactive"
                  disabled={disabled}
                >
                  Создать накладную
                </button>
...
export default connect(
  ...
  (dispatch) => ({
    ...
    set_Cargo_list_quantity: (param) => {
      dispatch({ type: "set_Cargo_list_quantity", payload: param });
    },
    set_Number: (param) => {
      dispatch({ type: "set_Number", payload: param });
    },

    set_Cargo_list: (param) => {
      dispatch({ type: "set_Cargo_list", payload: param });
    },

    set_popup: (param) => {
      dispatch({ type: "set_popup", payload: param });
    },
    set_popup_type: (param) => {
      dispatch({ type: "set_popup_type", payload: param });
    },

    SetPrice: (param) => {
      dispatch({ type: "SetPriceMobile", payload: param });
    },

    SetCargoWeight: (param) => {
      dispatch({ type: "SetCargoWeightMobile", payload: param });
    },
    SetCargoL: (param) => {
      dispatch({ type: "SetCargoLMobile", payload: param });
    },
    SetCargoW: (param) => {
      dispatch({ type: "SetCargoWMobile", payload: param });
    },
    SetCargoH: (param) => {
      dispatch({ type: "SetCargoHMobile", payload: param });
    },
    SetCargoQ: (param) => {
      dispatch({ type: "SetCargoQMobile", payload: param });
    },
    SetCargoType: (param) => {
      dispatch({ type: "SetCargoTypeMobile", payload: param });
    },
    SetCargoComm: (param) => {
      dispatch({ type: "SetCargoCommMobile", payload: param });
    },
    AddCargo: (param) => {
      dispatch({ type: "AddCargoMobile", payload: param });
    },
    RemoveCargo: (param) => {
      dispatch({ type: "RemoveCargoMobile", payload: param });
    },

    SetVolume: (param) => {
      dispatch({ type: "SetVolumeMobile", payload: param });
    },
    SetWeight: (param) => {
      dispatch({ type: "SetWeightMobile", payload: param });
    },
    SetTotal: (param) => {
      dispatch({ type: "SetTotalMobile", payload: param });
    },
    SetCOD: (param) => {
      dispatch({ type: "SetCODMobile", payload: param });
    },
    SetInsureValue: (param) => {
      dispatch({ type: "SetInsureValueMobile", payload: param });
    },
    ...
    SetCargoInfoType: (param) => {
      dispatch({ type: "SetCargoInfoTypeMobile", payload: param });
    },
    SetPayType: (param) => {
      dispatch({ type: "SetPayTypeMobile", payload: param });
    },

    SetSendCity: (param) => {
      dispatch({ type: "SetSendCityMobile", payload: param });
    },
    SetSendAdress: (param) => {
      dispatch({ type: "SetSendAdressMobile", payload: param });
    },
    SetSendCompany: (param) => {
      dispatch({ type: "SetSendCompanyMobile", payload: param });
    },
    SetSendPhone: (param) => {
      dispatch({ type: "SetSendPhoneMobile", payload: param });
    },
    SetSendPerson: (param) => {
      dispatch({ type: "SetSendPersonMobile", payload: param });
    },
    SetSendAddInfo: (param) => {
      dispatch({ type: "SetSendAddInfoMobile", payload: param });
    },
    SetSendTerminalList: (param) => {
      dispatch({ type: "SetSendTerminalListMobile", payload: param });
    },
    SetSendTerminal: (param) => {
      dispatch({ type: "SetSendTerminalMobile", payload: param });
    },
    SetSendSelectTerminal: (param) => {
      dispatch({ type: "SetSendSelectTerminalMobile", payload: param });
    },

    SetRecCity: (param) => {
      dispatch({ type: "SetRecCityMobile", payload: param });
    },
    SetRecAdress: (param) => {
      dispatch({ type: "SetRecAdressMobile", payload: param });
    },
    SetRecCompany: (param) => {
      dispatch({ type: "SetRecCompanyMobile", payload: param });
    },
    SetRecPhone: (param) => {
      dispatch({ type: "SetRecPhoneMobile", payload: param });
    },
    SetRecPerson: (param) => {
      dispatch({ type: "SetRecPersonMobile", payload: param });
    },
    SetRecAddInfo: (param) => {
      dispatch({ type: "SetRecAddInfoMobile", payload: param });
    },
    SetRecTerminalList: (param) => {
      dispatch({ type: "SetRecTerminalListMobile", payload: param });
    },
    SetRecTerminal: (param) => {
      dispatch({ type: "SetRecTerminalMobile", payload: param });
    },
    SetRecSelectTerminal: (param) => {
      dispatch({ type: "SetRecSelectTerminalMobile", payload: param });
    },
