            ...
            <nav className="mobile_menu">
                <div className="mobile_container">
                    <ul>
                        ...
                        {this.props.store.login.userkey === "000000234" ? (<li className="mobile_menu_item"><button className="mobile_menu_button" onClick={this.settings_window.bind(this, 'm_storage_reciept_list')}>Приемка на склад несколько</button></li>) : (null)}
