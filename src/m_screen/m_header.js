        ...
        return (
            <header className="header_mobile">
                <div className="mobile_container">
                    <img className={(this.props.store.general.active_window === 'm_delivered' || this.props.store.general.active_window === 'm_not_delivered') ? "blue_arrow" : "none"} src={arrow} onClick={this.menu_active_arrow.bind(this, 'm_disp')} alt="" />
