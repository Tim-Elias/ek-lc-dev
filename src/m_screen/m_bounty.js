...
class Screen extends React.Component {
  ...
  render() {
    ...
    return (
      <div>
        <div className="mobile_heading">Вознаграждение</div>
          ...
          <div className="mobile_container">
            ...
            <div className="finance_row">
              ...
              <div className="finance_item">
                {this.props.store.movement.profit_for_period} руб.
              </div>
            </div>
                ...
                {this.props.store.movement.disp_list.map((item, index) => (
                  <div key={index} className="cargo_item">
                    ...
                    {item.check === 1 ? (
                      <div>
                        <button
                          onClick={this.check_print.bind(this, item.disp)}
                        >
                          Чек
                        </button>
                        <br />
