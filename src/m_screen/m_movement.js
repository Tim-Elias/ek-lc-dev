...
class Screen extends React.Component {
  ...
  update = () => {
    ...
    let from =
      this.props.store.movement.date_start.split("-").reverse().join("-") +
      "_" +
      "00:00:00";
    let to =
      this.props.store.movement.date_end.split("-").reverse().join("-") +
      "_" +
      "23:59:59";
  ...
  render() {
    ...
    return (
      <div>
        <div className="mobile_heading">Движения ДС</div>
        {this.props.store.general.active_loader ? (
          ...
          <div className="mobile_container">
            <div className="finance_row">
              <input
                className="mobile_movememt_date"
                onChange={(e) => this.props.set_date_start(e.target.value)}
                value={this.props.store.movement.date_start}
                type="date"
              />
              -
              <input
                className="mobile_movememt_date"
                onChange={(e) => this.props.set_date_end(e.target.value)}
                value={this.props.store.movement.date_end}
                type="date"
              />
            </div>
            <button
              className="mobile_finance_button--b"
            ...
            <div className="finance_row">
              ...
              <div className="finance_item">
                {this.props.store.movement.balance_start} руб.
              </div>
            </div>
            ...
            <div className="finance_row">
              ...
              <div className="finance_item">
                {this.props.store.movement.balance_end} руб.
              </div>
            </div>

            <div className="mobile_disp_address_data">
              <div className="disp_address_data_header disp_address_data_header">
                Список
              </div>
...
export default connect(
  ...
  (dispatch) => ({
    ...
    set_balance_start: (param) => {
      dispatch({ type: "set_balance_start", payload: param });
    },
    set_balance_end: (param) => {
      dispatch({ type: "set_balance_end", payload: param });
    },
    set_disp_list: (param) => {
