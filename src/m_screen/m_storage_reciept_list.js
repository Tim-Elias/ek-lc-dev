...
class Screen extends React.Component {
    ...
    send_req = () => {
        let disp_list = this.props.store.storage_reciept.disp_list.map(item => item = item.num);
        const data = {
                    ...
                    <div className="storage_reciept_container">
                        ...
                        <div className="storage_reciept_item" style={{ display: "flex", justifyContent: "space-between" }}>
                            ...
                            <div style={{ display: "flex" }}>
                                Ввод:
                                <label className="switch">
                                    <input type="checkbox" value={this.props.store.storage_reciept.inputMode} onChange={() => this.props.storage_reciept_inputMode()} />
                                    <span className="slider round"></span>
                                </label>
                            </div>
                        ...
                        <button className="storage_reciept_button_m storage_reciept_button_m--fw" onClick={() => this.send_req()}>Получить</button>
...
export default connect(
    ...
    dispatch => ({
        ...
        storage_reciept_inputMode: (param) => { dispatch({ type: 'storage_reciept_inputMode', payload: param }) },
