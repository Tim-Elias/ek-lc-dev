...
export default function dispatch(state = initialState, action) {
  switch (action.type) {
    ...
    case "SetWarningAlert":
      return { ...state, warningAlert: action.payload };

    case "SetTermo":
      return {
        ...state,
        Termo: action.payload,
        TMax: action.payload ? state.TMax : 0,
        TMin: action.payload ? state.TMin : 0,
      };
    case "SetTMax":
      return { ...state, TMax: action.payload };
    case "SetTMin":
      return { ...state, TMin: action.payload };

    case "SetCyrillic":
      return { ...state, cyrillic: action.payload };

    case "SetWarningMessage":
      return { ...state, warningMessage: action.payload };

    case "SetPayerSelect":
      return { ...state, PayerSelect: action.payload };
    ...
    case "SetCustomNumber":
      return { ...state, customNumber: action.payload };
    case "SetAvailableNumber":
      return { ...state, availableNumber: action.payload };
    case "SetCustomNumberLoader":
      return { ...state, customNumberLoader: action.payload };

    case "SetPrice":
      return { ...state, Price: action.payload };

    case "SetDelMethod":
      return { ...state, DelMethod: action.payload };

    case "SetPayerList":
      return { ...state, PayerList: action.payload };

    case "SetPayer":
      return { ...state, Payer: action.payload };

    case "SetCOD":
      return { ...state, COD: action.payload };
    case "SetInsureValue":
      return { ...state, InsureValue: action.payload };

    case "SetOpenModalRecTemplate":
      return { ...state, OpenModalRecTemplate: action.payload };
    case "SetOpenModalSendTemplate":
      return { ...state, OpenModalSendTemplate: action.payload };

    case "SetFilterModalSendTemplate":
      return { ...state, FilterModalSendTemplate: action.payload };
    case "SetFilterModalRecTemplate":
      return { ...state, FilterModalRecTemplate: action.payload };

    case "SetSelectedSendCity":
      return { ...state, SelectedSendCity: action.payload };
    case "SetSelectedRecCity":
      return { ...state, SelectedRecCity: action.payload };

    case "SetPayType":
      return { ...state, PayType: action.payload };
    case "SetSendCity":
      return { ...state, SendCity: action.payload };
    case "SetSendAdress":
      return { ...state, SendAdress: action.payload };
    case "SetSendCompany":
      return { ...state, SendCompany: action.payload };
    case "SetSendPhone":
      return { ...state, SendPhone: action.payload };
    case "SetSendPerson":
      return { ...state, SendPerson: action.payload };
    case "SetSendAddInfo":
      return { ...state, SendAddInfo: action.payload };
    ...
    case "SetSendEmailInformer":
      return { ...state, SendEmailInformer: action.payload };

    case "SetRecCity":
      return { ...state, RecCity: action.payload };
    case "SetRecAdress":
      return { ...state, RecAdress: action.payload };
    case "SetRecCompany":
      return { ...state, RecCompany: action.payload };
    case "SetRecPhone":
      return { ...state, RecPhone: action.payload };
    case "SetRecPerson":
      return { ...state, RecPerson: action.payload };
    case "SetRecAddInfo":
      return { ...state, RecAddInfo: action.payload };
    case "SetRecEmail":
      return { ...state, RecEmail: action.payload };
    case "SetRecTerminal":
      return {
        ...state,
    ...
    case "SetDispDate":
      if (
        state.DelMethod === "Дверь - Дверь" ||
        state.DelMethod === "Дверь - Склад"
      ) {
    ...
    case "SetIRR":
      return { ...state, PayType: action.payload };
    case "SetFragile":
      return { ...state, Fragile: action.payload };
    case "SetDelType":
      return { ...state, DelType: action.payload.value };

    case "SetCustomerEmailInformer":
      return { ...state, CustomerEmailInformer: action.payload };

    case "SetCityList":
      return { ...state, CityList: action.payload };
    case "SetSendSelectTerminal":
      return { ...state, SendSelectTerminal: action.payload };
